PROJECT {
  ...
  AUDIT { TIMESTAMP = 1480378478; NAME = cristian.munoz; LICENSE = FT 10005 35 HS; RELEASE = 8.00b; COMMENT {Last Edit} }
  SHELLOPTIONS {
    ONLINE_CODE         = ON;
  ...
  MODEL {
    ...
    OBJECT_SECTION {
      RULEBLOCK {
        ...
        NAME = RB1;
        AUDIT { TIMESTAMP = 1480378478; NAME = cristian.munoz; LICENSE = FT 10005 35 HS; RELEASE = 8.00b; COMMENT {EditRuleGroup(G1 - 21F37EDF-E787-46C6-8B64-F87DD8504F14)} }
        ...
        RULEGROUP {
          ...
          AUDIT { TIMESTAMP = 1480378478; NAME = cristian.munoz; LICENSE = FT 10005 35 HS; RELEASE = 8.00b; COMMENT {EditRule(R3 - 7916A4E4-84F5-4BFE-BA41-9E1898234434)} }
          RULE {
          ...
          RULE {
            ...
            AUDIT { TIMESTAMP = 1480378478; NAME = cristian.munoz; LICENSE = FT 10005 35 HS; RELEASE = 8.00b; COMMENT {ReplaceConclusionTerm('Power.neg_medium' with 'Power.pos_medium')} }
            IF    Angle = pos_small
              AND Distance = close
