...
\begin{table}[H]
	...
	\begin{tabular}{|l|l|l|l|}
		\hline
		\multicolumn{4}{|l|}{Número máximo de gerações} \\ \hline
		10   & 50    & 200    & 500    \\ \hline
	\end{tabular}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabular}{|l|l|l|l|}
		\hline
		\multicolumn{4}{|l|}{Taxa de Mutação} \\ \hline
		0.001    & 0.25    & 0.5    & 0.75    \\ \hline
	\end{tabular}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabular}{|l|l|l|l|}
		\hline
		\multicolumn{4}{|l|}{Taxa de Crossover} \\ \hline
		0    & 0.25    & 0.75    & 1    \\ \hline
	\end{tabular}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabular}{|l|l|l|}
		\hline
		\multicolumn{3}{|l|}{Tipos de Crossover} \\ \hline
